package com.example.drivedatadollars
...
import com.example.drivedatadollars.ui.theme.drivedatadollarsTheme
import com.example.drivedatadollars.ui.theme.DarkColor
import com.example.drivedatadollars.ui.theme.BlueColor
import com.example.drivedatadollars.ui.theme.TanColor
...
fun drivedatadollarsApp(
    ...
    when (currentScreen) {
        ...
        Screen.Landscape -> {
            LandscapedrivedatadollarsScreen(
                imageApiService,
...
fun OpeningPage(onContinue: (String) -> Unit) {
    ...
    Column(
        ...
        Text(
            text = "Get paid by contributing to self driving car research",
...
@Composable
fun LandscapedrivedatadollarsScreen(
    imageApiService: ImageApiService,
    metagraphDataL1ApiService: MetagraphDataL1ApiService,
    devicePrivateKey: String,
    cameraManager: CameraManager,
    ...
    drivedatadollarsScreen(imageApiService, metagraphDataL1ApiService, devicePrivateKey, cameraManager, walletAddress)
}

@SuppressLint("MissingPermission")
@Composable
fun drivedatadollarsScreen(
    imageApiService: ImageApiService,
    metagraphDataL1ApiService: MetagraphDataL1ApiService,
    devicePrivateKey: String,
    cameraManager: CameraManager,
                ...
                if (!isCameraPositionConfirmed) {
                    ...
                    Text(
                        text = when (lastCaptureStatus) {
                            CaptureStatus.Success -> "Amount earned this drive"
...
fun formatReward(reward: BigInteger): String {
    val divisor = BigDecimal.TEN.pow(8)
